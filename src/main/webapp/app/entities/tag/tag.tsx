...
import { searchEntities, getEntities, reset } from './tag.reducer';
      ...
      <h2 id="tag-heading" data-cy="TagHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="galleryApp.tag.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('galleryApp.tag.home.search')}
                />
          ...
          {tagList && tagList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="galleryApp.tag.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="galleryApp.tag.home.notFound">No Tags found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
