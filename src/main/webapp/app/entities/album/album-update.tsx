  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="galleryApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('galleryApp.album.title')}
                id="album-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('galleryApp.album.description')}
              ...
              />
              <ValidatedField
                label={translate('galleryApp.album.created')}
                id="album-created"
                name="created"
                data-cy="created"
                type="datetime-local"
              ...
              />
              <ValidatedField id="album-user" name="userId" data-cy="user" label={translate('galleryApp.album.user')} type="select">
                <option value="" key="0" />
                {users
