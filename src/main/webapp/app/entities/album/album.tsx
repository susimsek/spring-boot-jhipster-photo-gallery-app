...
import { searchEntities, getEntities } from './album.reducer';
      ...
      <h2 id="album-heading" data-cy="AlbumHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="galleryApp.album.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('galleryApp.album.home.search')}
                />
        ...
        {albumList && albumList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="galleryApp.album.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="galleryApp.album.home.notFound">No Albums found</Translate>
            </div>
          )
        )}
      </div>
