  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="galleryApp.photo.home.createOrEditLabel" data-cy="PhotoCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('galleryApp.photo.title')}
                id="photo-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('galleryApp.photo.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('galleryApp.photo.image')}
                id="photo-image"
                name="image"
                data-cy="image"
                isImage
              ...
              />
              <ValidatedField readOnly label={translate('galleryApp.photo.height')} id="photo-height" name="height" data-cy="height" type="text" />
              <ValidatedField readOnly label={translate('galleryApp.photo.width')} id="photo-width" name="width" data-cy="width" type="text" />
              <ValidatedField
                label={translate('galleryApp.photo.taken')}
                id="photo-taken"
                readOnly
                name="taken"
                data-cy="taken"
              ...
              />
              <ValidatedField
                label={translate('galleryApp.photo.uploaded')}
                id="photo-uploaded"
                readOnly
                name="uploaded"
                data-cy="uploaded"
                ...
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField id="photo-album" name="albumId" data-cy="album" label={translate('galleryApp.photo.album')} type="select">
                <option value="" key="0" />
                {albums
              ...
              <ValidatedField label={translate('galleryApp.photo.tag')} id="photo-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
